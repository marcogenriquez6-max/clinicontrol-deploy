  ...
  return (
    <Card className="flex flex-col h-full">
        ...
        <div className="flex items-center gap-3 min-w-0">
          ...
          <div className="min-w-0">
            ...
            <div className="flex flex-wrap gap-1 mt-1">
              {info.hu.map(h => (
                <span key={h} className="px-1.5 py-0.5 text-xs font-medium rounded border border-[var(--border-primary)] bg-[var(--bg-secondary)] text-[var(--text-tertiary)]">{h}</span>
              ))}
            </div>
          </div>
        </div>
      ...
      <div className="mt-4 pt-3 border-t border-[var(--border-primary)]">
        <p className="text-xs font-semibold uppercase tracking-wider text-[var(--text-tertiary)] mb-2">Módulos visibles</p>
